...
<body>
  <div class="form-section">
    <div class="container">
      <form action="a6_form.php" method="post" enctype="multipart/form-data">
        ...
        <ul>
          ...
          <li class="form-item">
            ...
            <input type="tel" name="phone" id="phone" placeholder="Phone Number" value="+91" onkeyup="phoneValidation()" required>
            <span id="phone_error"></span>
          </li>
          <li class="form-item">
            <label for="email">Email :</label>
            <input type="text" name="email" id="email" placeholder="Email" onkeyup="validateEmail()" required>
